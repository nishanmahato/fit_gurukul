...
<html lang="en">
<head>
    <title>Welcome-Fit Gurukul</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="keywords" content="Fit Gurukul | a state of the art GYM  | Best GYM | ">
    <meta name="description" content="Fit Gurukul |  complete with equipment for cardio and strength training | Zumba and Yoga classes">
    <meta name="author" content="Nishan Mahato">
    <!-- Bootstrap CSS -->
   ...
   <div id="carouselId" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="carousel-item active">
            <img src="assets/images/slideA.jpg" alt="First slide">
        ...
        <div class="carousel-item">
            <img src="assets/images/jumba.png" alt="Second slide">
            <div class="carousel-caption d-none d-md-block">
                <h3>Zumba</h3>
        ...
        <div class="carousel-item">
            <img src="assets/images/yoga1.jpg" alt="Third slide">
            <div class="carousel-caption d-none d-md-block">
                <h3>Yoga</h3>
    ...
    <div class="container text-center">
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <img src="assets/images/gym1.jpg" alt="gym" class="img-thumbnail">
                <p>Price: Rs. 3000</p>
            ...
            <div class="col-md-4">
                ...
                <img src="assets/images/gym2.jpg" alt="Zumba" class="img-thumbnail">
                <p>Price: Rs. 5000</p>
                <a href="book-now.php" class="btn btn-danger">Register Now</a>
            </div>
            <div class="col-md-4">
                ...
                <img src="assets/images/yogaclass.jpg" alt="yoga" class="img-thumbnail">
                <p>Price: Rs. 5000</p>
                <a href="book-now.php" class="btn btn-danger">Register Now</a>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <img src="assets/images/yoga2.jpg" alt="yoga" class="img-thumbnail">
                <p>Price: Rs. 8000</p>
                <a href="book-now.php" class="btn btn-danger">Register Now</a>
            </div>
            <div class="col-md-4">
                ...
                <img src="assets/img/sauna.jpg" alt="sauna" class="img-thumbnail">
                <p>Price: Rs. 1500</p>
                <a href="book-now.php" class="btn btn-danger">Register Now</a>
            </div>
            <div class="col-md-4">
                ...
                <img src="assets/images/jumba2.jpg" alt="platinum" class="img-thumbnail">
                <p>Price: Rs. 12000</p>
                <a href="book-now.php" class="btn btn-danger">Register Now</a>
            </div>
        </div>
