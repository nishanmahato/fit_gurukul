  ...
  <body>
   ...
   <div class="container-fluid bg-white" style="padding: 40px;">
     <div class="container">
        <div class="row">
            <div class="col-md-9">
            <strong style="font-size=40px;">Fit Gurukul</strong>
            <p><i class="fa fa-map-marker"></i> Bharatpur-12, Chitwan, Nepal</p>
            <p><i class="fa fa-envelope"></i> +977 9855099887</p>
            <p><i class="fa fa-envelope"> </i> gurukul.fit@gmail.com</p>
            <p><i class="fa fa-globe"></i> <a href="https://www.fitgurukul.com.np">
