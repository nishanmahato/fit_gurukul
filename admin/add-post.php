...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-fluid" style="margin-top: 40px;">
      <div class="row">
        <div class="col-md-3">
          <a href="users.php" class="btn btn-dark btn-block" >Users</a>
          <a href="reservation.php" class="btn btn-dark btn-block" >Reservations</a>
          <a href="upload-image.php" class="btn btn-dark btn-block" >Upload Image</a>
          <a href="add-post.php" class="btn btn-dark btn-block" >Add Posts</a>
        </div>
        <div class="col-md-9">
          <h1>Add new post</h1>
          <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <textarea class="form-control" name="content" id="content" rows="3" placeholder="Your content"></textarea>
            </div>
          ...
          <br>
          <?php
          include '../connection.php'; // connection require
          if(isset($_POST['submit']))
          {
            $title=$_POST['title']; //added new
            $content=$_POST['content']; //added new
            ...
            {
            //change directory images and remove $run variable
