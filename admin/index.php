      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6" style="margin-top: 50px;">
            <h2 class="display-4">Log in to Fit Gurukul</h2>
            <img src="../assets/images/slideA.jpg" alt="" class="img-thumbnail">
          </div>
          <div class="col-md-6" >
           <form action="?" method="post" style="background-color: lightblack; padding: 100px 50px; margin-top: 50px; box-shadow: 2px 2px gray; border-radius: 10px;">
